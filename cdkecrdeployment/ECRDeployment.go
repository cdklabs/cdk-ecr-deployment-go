...
import (
	...
	"github.com/cdklabs/cdk-ecr-deployment-go/cdkecrdeployment/v4/internal"
)
...
func (e *jsiiProxy_ECRDeployment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
